    ...
    <div class="page-title">
        <div class="row gutters">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                <h5 class="title" @click="logout">Chat App {{lastMessage}}</h5>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                <div class="daterange-container">
                    <div class="date-range">
                        <div id="reportrange">
                            ...
                            <span class="range-text" @click="reloadd">Jun 11, 2019 - Jul 10, 2019</span>
                        ...
                        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-9 col-9">
                            ...
                            <div class="chat-container">
                                ...
                                <div class="form-group mt-3 mb-0">
                                    ...
                                    v-on:keyup.enter="sendMessage" v-model="content"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
  ...
  var firebaseAuth=firebase.auth(firebase.apps[0]);//currentUser
 ...
 export default {
   ...
   let messagesRef =  db.collection('messages').doc(firebaseAuth.X).collection('message');
/*
  messagesRef.onSnapshot(querySnapShot => {
      querySnapShot.docChanges().forEach(change => {
     //   if (change.type === 'added') 
            console.log(this.inc++,change.doc.data());
...
this.elem =
 messagesRef
                .orderBy('date', 'desc')//.startAfter("today")
                .limit(1)
                .onSnapshot(messages => {
                    messages.docChanges().forEach(message => {
                       console.log(this.inc+++"***",message.doc.data());
                    })
                })
...
watch: {
      '$route.params.id' (newId, oldId) {
        console.log("yesssssssssssssss",newId,oldId);
              }
    },
  methods: {
reloadd () {
